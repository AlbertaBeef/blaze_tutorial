...
model_palm_detector_v0_10_full=("palm_detection_full","models/palm_detection_lite/model_float32.onnx",192)
...
model_hand_landmark_v0_10_full=("hand_landmark_full","models/hand_landmark_lite/model_float32.onnx",224)
model_list=(
