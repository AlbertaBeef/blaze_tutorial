...
do
	...
	echo python3 deepx_flow.py --name ${model_name} --model ${model_file} --resolution ${input_resolution}

	python3 deepx_flow.py --name ${model_name} --model ${model_file} --resolution ${input_resolution} | tee deploy_${model_name}.log
